...
export default function Footer() {
  ...
  <span className="transition-all duration-300 text-black bg-[#89f436] hover:bg-transparent hover:text-[#89f436] hover:border-[#89f436] border border-[#89f436] rounded-full p-2 cursor-pointer">
    <Facebook />
  </span>
  <span className="transition-all duration-300 text-black bg-[#89f436] hover:bg-transparent hover:text-[#89f436] hover:border-[#89f436] border border-[#89f436] rounded-full p-2 cursor-pointer">
    <Twitter />
